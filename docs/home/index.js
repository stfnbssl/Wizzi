/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\docs\.wizzi\ittf\pages\home\index.js.ittf
    utc time: Fri, 12 Feb 2021 20:02:14 GMT
*/
'use strict';
...
function m1_reset() {
    wz.removeClass('#Docs-dropdown', 'css-1ropak3')
    wz.addClass('#Docs-dropdown', 'css-1sg6jvm')
    wz.removeClass('#Features-dropdown', 'css-1ropak3')
    wz.addClass('#Features-dropdown', 'css-1sg6jvm')
    wz.removeClass('#Productions-dropdown', 'css-1ropak3')
    wz.addClass('#Productions-dropdown', 'css-1sg6jvm')
    wz.removeClass('#Community-dropdown', 'css-1ropak3')
    wz.addClass('#Community-dropdown', 'css-1sg6jvm')
}
function eco_reset() {
    wz.removeClass('#ecoPlugins-dropdown', 'css-17502ce')
    wz.addClass('#ecoPlugins-dropdown', 'css-1ds30p3')
    wz.removeClass('#ecoSchemas-dropdown', 'css-17502ce')
    wz.addClass('#ecoSchemas-dropdown', 'css-1ds30p3')
    wz.removeClass('#ecoJobs-dropdown', 'css-17502ce')
    wz.addClass('#ecoJobs-dropdown', 'css-1ds30p3')
}
wz.contentLoaded(() => {
    ...
    wz.click('#Docs', (ev) => {
        ...
        m1_reset();
        eco_reset();
        wz.addClass('#Docs-dropdown', 'css-1ropak3')
        wz.removeClass('#Docs-dropdown', 'css-1sg6jvm')
        ev.stopPropagation();
    })
    wz.click('#Features', (ev) => {
        console.log("Clicked Features");
        m1_reset();
        eco_reset();
        wz.addClass('#Features-dropdown', 'css-1ropak3')
        wz.removeClass('#Features-dropdown', 'css-1sg6jvm')
        ev.stopPropagation();
    })
    wz.click('#Productions', (ev) => {
        console.log("Clicked Productions");
        m1_reset();
        eco_reset();
        wz.addClass('#Productions-dropdown', 'css-1ropak3')
        wz.removeClass('#Productions-dropdown', 'css-1sg6jvm')
        ev.stopPropagation();
    })
    wz.click('#Community', (ev) => {
        console.log("Clicked Community");
        m1_reset();
        eco_reset();
        wz.addClass('#Community-dropdown', 'css-1ropak3')
        wz.removeClass('#Community-dropdown', 'css-1sg6jvm')
        ev.stopPropagation();
    })
    wz.click('#ecoPlugins', (ev) => {
        console.log("Clicked Plugins");
        eco_reset();
        wz.removeClass('#ecoPlugins-dropdown', 'css-1ds30p3')
        wz.addClass('#ecoPlugins-dropdown', 'css-17502ce')
        ev.stopPropagation();
    })
    wz.removeClass('#ecoPlugins-dropdown', 'css-1ds30p3')
    wz.addClass('#ecoPlugins-dropdown', 'css-17502ce')
    wz.click('#ecoSchemas', (ev) => {
        console.log("Clicked Schemas");
        eco_reset();
        wz.removeClass('#ecoSchemas-dropdown', 'css-1ds30p3')
        wz.addClass('#ecoSchemas-dropdown', 'css-17502ce')
        ev.stopPropagation();
    })
    wz.click('#ecoJobs', (ev) => {
        console.log("Clicked Jobs");
        eco_reset();
        wz.removeClass('#ecoJobs-dropdown', 'css-1ds30p3')
        wz.addClass('#ecoJobs-dropdown', 'css-17502ce')
        ev.stopPropagation();
    })
    wz.click(document.body, () => {
