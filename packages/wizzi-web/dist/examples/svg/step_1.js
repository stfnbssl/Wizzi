/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-web\.wizzi\ittf\examples\svg\step_1.js.ittf
*/
'use strict';
//
...
var svg_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    ...
    async.mapSeries(example_ittfs, function(ittf, callback) {
        console.log('======================================================================================');
        console.log('generate file', ittf + '.svg.ittf');
        console.log('--------------------------------------------------------------------------------------');
        loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', ittf + '.svg.ittf'), {}, "svg/document", function(err, artifactText) {
            if (err) {
                console.log('-------------------------------------------------------------------');
...
svg_step_1.__name = 'svg_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - svg_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
