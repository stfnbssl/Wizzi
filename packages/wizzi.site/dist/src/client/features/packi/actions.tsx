/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\client\src\features\packi\actions.tsx.ittf
...
import {PackiFiles, PackiTemplate, CreatePackiOptions} from './types';
...
export interface CreatedPackiPayload extends ResponsePayload {
    id: string;
    files: PackiFiles;
}
...
export interface GitRepositoryListPayload extends ResponsePayload {
...
export interface ClonedGitRepositoryPayload extends ResponsePayload {
...
export interface CommittedGitRepositoryPayload extends ResponsePayload {
}
