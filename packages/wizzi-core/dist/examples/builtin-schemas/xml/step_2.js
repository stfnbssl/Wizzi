/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\xml\step_2.js.ittf
*/
'use strict';
/**
...
var Schemas_xml_step_2 = function(step_callback) {
    heading1('EXAMPLE');
    loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'basic.xml.ittf'), {}, "xml/document", function(err, artifactText) {
        if (err) {
            console.log('err', err);
