/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\wfschema\step_1.js.ittf
*/
'use strict';
/**
...
var Schemas_ittf_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    executeGenerateSchema('basic', function(err, result) {
        if (err) {
            console.log('err', err);
