/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\ittf\step_1.js.ittf
*/
'use strict';
/**
     Example: Schemas_ittf_step_1
...
var Schemas_ittf_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadWizziModel(path.join(__dirname, 'ittf', 'basic.ittf.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - Schemas_ittf_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_ittf_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_ittf_step_1;
