/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-js\.wizzi\ittf\examples\ts\step_1.js.ittf
*/
'use strict';
//
...
var ts_step_1 = function(step_callback) {
    heading1('EXAMPLE')
    ...
    async.mapSeries(example_ittfs, function(ittf, callback) {
        console.log('======================================================================================');
        console.log('generate file', ittf + '.ts.ittf');
        console.log('--------------------------------------------------------------------------------------');
        loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', ittf + '.ts.ittf'), {}, "ts/module", function(err, artifactText) {
            if (err) {
                console.log('err', err);
...
ts_step_1.__name = 'ts_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - ts_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
