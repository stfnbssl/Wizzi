/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\text\step_1.js.ittf
*/
'use strict';
/**
     Example: Schemas_yaml_step_1
...
var Schemas_yaml_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadWizziModel(path.join(__dirname, 'ittf', 'basic.text.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        // for built-in schema text the wizziModel returned is a json object
        printObject(wizziModel);
    });
};
Schemas_yaml_step_1.__name = 'Schemas_yaml_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Schemas_yaml_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_yaml_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_yaml_step_1;
