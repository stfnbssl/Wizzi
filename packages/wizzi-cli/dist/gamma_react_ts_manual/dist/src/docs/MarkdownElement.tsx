/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\gamma_react_ts_manual\.wizzi\src\docs\MarkdownElement.tsx.ittf
...
renderer.heading = // Small title. No need for an anchor.
...
(text: string, level: number) => {
    ...
    return (`
    <h${level}>
      <a class="anchor-link" id="${escapedText}"></a>${text}`) + (`<a class="anchor-link-style" href="#${escapedText}">
...
function MarkdownElement(props: Props) {
    ...
    return  (
        <div className={clsx(classes.root, 'markdown-body', className)} dangerouslySetInnerHTML={{
