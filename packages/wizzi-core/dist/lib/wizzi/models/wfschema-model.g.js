...
var element = (function (schemaitem) {
    ...
    function element(name, sourceLineInfo) {
        ...
        this.allowedNames = [ "number", "css-length"];
    ...
    element.NAME_NUMBER = "number";element.NAME_CSS_LENGTH = "css-length";element.prototype.addAttribute = function(name, sourceLineInfo) {
    ...
    element.prototype.wzVerify = function(ctx) {
        ctx.verifyEnum("element", "Name", this.wzName, this.allowedNames, this);
