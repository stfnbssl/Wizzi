/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\ittf\examples\liner\step_1.js.ittf
*/
'use strict';
//
...
var Liner_Step_1 = function(step_callback) {
    heading1('EXAMPLE');
    var lines = liner(file.read(path.join(__dirname, 'ittf', 'liner_1.ittf')), {
        sourceKey: 'f1'
    });
    printLines(lines);
};
Liner_Step_1.__name = 'Liner_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Liner_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
