/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\shared\CollapsibleObject.tsx.ittf
                                    ...
                                    return typeof item === 'object' && item !== null && Object.keys(item).length ?  (
                                         ...
                                         :  (
                                            <div key={key} className={css(styles.item)}>
                                                <span className={css(styles.label, styles.key)}>
                                                    {key}
                                                    :
                                                </span>
