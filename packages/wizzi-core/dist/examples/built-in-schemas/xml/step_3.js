/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\schemas\xml\step_3.js.ittf
*/
'use strict';
/**
     Example: Schemas_xml_step_3
...
var Schemas_xml_step_3 = function(step_callback) {
    heading1('EXAMPLE');
    loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'basic.xml.ittf'), {}, "xml/export", function(err, artifactText) {
        if (err) {
            console.log('err', err);
...
Schemas_xml_step_3.__name = 'Schemas_xml_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - Schemas_xml_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_xml_step_3 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_xml_step_3;
