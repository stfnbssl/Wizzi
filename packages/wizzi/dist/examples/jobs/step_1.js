/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\ittf\examples\jobs\step_1.js.ittf
*/
'use strict';
//
...
jobs_step_1.__name = 'jobs_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - jobs_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
