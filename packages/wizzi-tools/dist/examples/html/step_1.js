/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-tools\.wizzi\ittf\examples\html\step_1.js.ittf
*/
'use strict';
//
...
async.mapSeries(example_htmls, function(name, callback) {
    console.log('======================================================================================');
    console.log('wizzify file', name + '.html');
    console.log('--------------------------------------------------------------------------------------');
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - wizzify_html_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wizzify_html_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
