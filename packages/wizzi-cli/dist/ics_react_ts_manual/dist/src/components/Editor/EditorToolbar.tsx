/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\EditorToolbar.tsx.ittf
...
type Props = authTypes.AuthProps & // isResolving: boolean;
// 
{ 
    classes: any;
            ...
            <React.Fragment>
                ...
                <AppBar className={classes.appBar} position="static">
                    <Toolbar>
                        ...
                        <Select value={this.props.splitViewKind} onChange={this.props.onChangeSplitViewKind}>
                            <MenuItem value={'left'}>
                                Left
                            </MenuItem>
                ...
                <AppSidebar />
                <ModalAuthentication visible={this.state.isLoggingIn && isAuthModalVisible}
