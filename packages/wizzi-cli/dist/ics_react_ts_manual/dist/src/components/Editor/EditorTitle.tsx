/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\EditorTitle.tsx.ittf
...
class EditorTitle extends React.Component<Props, State> {
    ...
    render() {
        ...
        if (loggedUser) {
            ...
            statusText =  (
            <React.Fragment>
                <button className={css(styles.textButton)}
                //
                //
                >
                    Log in
        ...
        return  (
            <div className={css(styles.container)}>
                <div className={css(styles.header)}>
                    <div className={css(styles.titleContainer)}>
                        ...
                        <React.Fragment>
                            ...
                            <button className={css(styles.icon, theme === 'light' ? styles.infoLight : styles.infoDark)} />
                        </Popover>
                    </div>
                        ...
                        }
                        {
                            (loggedUser && saveStatus === 'saved-draft') || saveStatus === 'published' ?  (
                                <svg className={css(styles.check)}
                                    ...
                                    viewBox="0 0 11 8"
                                >
                                    <polygon fill="#4CAF50" points="3.34328358 6.32835821 0.835820896 3.82089552 0 4.65671642 3.34328358 8 10.5074627 0.835820896 9.67164179 0" />
                                </svg>
                                )
                             : null
                        }
                ...
                <ModalEditTitleAndDescription title="Edit Packi Details"
                    action="Done"
