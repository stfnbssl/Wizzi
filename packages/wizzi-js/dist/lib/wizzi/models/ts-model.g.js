...
var statement = (function (tsBase) {
    ...
    statement.prototype.loadChild = function(child) {
        ...
        if (name === 'exporttype') {
            return this.wzLoadToChildColl(child, _md.exportType, this.statements);
        }
        if (name === 'will-mount') {
            return this.wzLoadToChildColl(child, _md.willMount, this.statements);
        }
...
// element exportType
var exportType = (function (statement) {
    _inherits(exportType, statement);
    function exportType(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(exportType.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, exportType);
        this.wzElement = "exportType";
    }
    return exportType;
})(statement);

_md.exportType = exportType;
