/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\containers\PackiManager.tsx.ittf
...
class PackiManagerContainer extends React.Component<Props, State> {
    componentDidMount() {
        ...
        if (this.props.preferences.connectGithubRepos) {
            this.props.dispatchFetchOwnedGitRepositories(this.props.loggedUser.uid);
        }
    }
    ...
    _handleCommitGitRepository = async (owner: string, name: string, branch: string, virtualFiles: boolean) => {
        ...
        this.props.dispatchCommitGitRepository(this.props.loggedUser.uid, owner, name, branch, files);
        this.props.onClose();
    }
    ;
    ...
    render() {
        ...
        if (packiNames && packiTemplateNames//
            ...
            return  (
                <PackiManager currentPacki={currentPacki}
...
export default connect<StateProps, DispatchProps>(mapStateToProps, mapDispatchToProps)(withPreferences(PackiManagerContainer))
