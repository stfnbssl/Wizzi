/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\features\preferences\withThemeName.tsx.ittf
                    ...
                    >
                        {
                            (props) => {
                                ...
                                // @ts-ignore
                                return  ( <Comp
                                     ref={__forwardedRef} theme={props.preferences.theme} {...rest} />
                                    )
                                ;
