/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\EditorView\EditorView.tsx.ittf
...
type ModalName = PublishModals | 'edit-info' | 'shortcuts' | 'previous-saves';
...
export default withPreferences(connect((state: any) => 
