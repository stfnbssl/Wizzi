/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Auth\OAuthLogin.tsx.ittf
            ...
            <div>
                {
                    username ?  (
                        <Card className={classes.card}>
                            <CardActionArea>
                                <CardMedia className={classes.media} image={picture} title={displayName} />
                                <CardContent>
                            ...
                            <CardActions>
                                <Fab variant="extended" onClick={this.closeCard}>
                                    Logoff
                                </Fab>
                            </CardActions>
                        </Card>
