...
var item = (function (svgBase) {
    ...
    item.prototype.getAttributes = function(attrs) {
        return extractAttributes(this, 'id;class;dataName;href;rotate;transform;xmlns;xmlBase;xmlLang;xmlSpace;pathLength', attrs);
    }
