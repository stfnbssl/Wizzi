/*
    ...
    primary source IttfDocument: C:\my\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\json\step_1.js.ittf
*/
'use strict';
/**
     Example: Schemas_json_step_1
...
var Schemas_json_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadWizziModel(path.join(__dirname, 'ittf', 'basic.json.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
...
Schemas_json_step_1.__name = 'Schemas_json_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Schemas_json_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_json_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_json_step_1;
