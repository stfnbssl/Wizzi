/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\filelist\FileListOpenEntry.tsx.ittf
...
class FileListOpenEntry extends React.PureComponent<Props, State> {
    ...
    _handleDocumentContextMenu = (e: MouseEvent) => {
        if (e.target === this._item.current || (this._item.current && this._item.current.contains(e.target  as Node))) {
            e.preventDefault();
    ...
    render() {
        ...
        return  (
            ...
            >
                <button onClick={this.props.onClose} className={css(styles.close, this.state.isHovered ? styles.closeFocused : styles.closeBlurred)}>
                    ×
                </button>
