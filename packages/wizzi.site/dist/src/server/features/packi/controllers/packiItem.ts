/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\server\src\features\packi\controllers\packiItem.ts.ittf
...
export class PackiItemController implements ControllerType {
    ...
    private updatePackiItem = async (request: Request, response: Response) => 
