    ...
    _defineProperty(_assertThisInitialized(_this), "_initializeFile", (path, value) => {
      ...
      if (model && !model.isDisposed()) {
        ...
        if (path.endsWith('.ittf')) {
          model = monaco_editor_esm_vs_editor_editor_main__WEBPACK_IMPORTED_MODULE_3__.editor.createModel(value, 'ittf');
        } else {
...
//# sourceMappingURL=MonacoEditor.55ec7583965f98090229.chunk.js.map