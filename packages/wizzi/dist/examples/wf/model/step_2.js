/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi\.wizzi\ittf\examples\wf\model\step_2.js.ittf
*/
'use strict';
//
...
var wf_model_step_2 = function(step_callback) {
    heading1('EXAMPLE')
...
wf_model_step_2.__name = 'wf_model_step_2';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - wf_model_step_2 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- wf_model_step_2 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = wf_model_step_2;
