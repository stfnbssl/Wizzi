/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\Editor\MonacoEditor.tsx.ittf
    ...
    getWorker(_: string, label: string) {
        switch (label) {
            case 'json': {
                ...
                // @ts-ignore
                return new Worker('monaco-editor/esm/vs/language/json/json.worker', { type: 'module'  }); 
            }
            case 'typescript':
            case 'javascript': {
