/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\features\packi\data.tsx.ittf
...
export async function savePackiFiles(packiId: string, files: PackiFiles):  Promise<void> {
    ...
    return new Promise(async (resolve, reject) => {
            ...
            asyncmap(keys, async (k: string, callback: cb<any>) => {
                ...
                await bfs.writeFile(path.join(config.BROWSERFS_PACKIES_FOLDER, packiId, k), file.contents);
