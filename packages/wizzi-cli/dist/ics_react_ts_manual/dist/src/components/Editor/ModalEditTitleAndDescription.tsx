/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\ModalEditTitleAndDescription.tsx.ittf
            ...
            return  (
                <ModalDialog visible={visible} title={title} onDismiss={onDismiss}>
                    <Form onSubmit={this._handleSubmit}>
                        ...
                        <LargeTextArea value={this.state.description}
                            onChange={e => 
                                this.setState({
