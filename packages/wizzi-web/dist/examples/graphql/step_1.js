/*
    ...
    primary source IttfDocument: C:\my\wizzi\stfnbssl\wizzi\packages\wizzi-web\.wizzi\ittf\examples\graphql\step_1.js.ittf
*/
'use strict';
//
...
var graphql_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    heading2('basic graphql generations');
    const example_ittfs = [
        'basic'
    ];
    async.mapSeries(example_ittfs, function(ittf, callback) {
        console.log('======================================================================================');
        console.log('generate file', ittf + '.graphql.ittf');
        console.log('--------------------------------------------------------------------------------------');
        loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', ittf + '.graphql.ittf'), {}, "graphql/document", function(err, artifactText) {
            if (err) {
                console.log('-------------------------------------------------------------------');
...
graphql_step_1.__name = 'graphql_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - graphql_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- graphql_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
