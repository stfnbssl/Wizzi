/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\EditorFooter.tsx.ittf
...
export type Props = prefTypes.PreferencesContextType & // loadingMessage: string | undefined;
        ...
        <FooterShell type={isErrorFatal && !isLoading ? 'error' : isLoading ? 'loading' : null}>
            <div className={css(styles.left)}>
                {
                    // 
                    isLoading ?  (
                        <LoadingText className={css(styles.loadingText)}>
                            {
                                //
            ...
            <React.Fragment>
                <div className={css(styles.buttonItem, styles.buttonItemEditorPane)}>
                    <IconButton title="Show keyboard shortcuts" label="Shortcuts" onClick={onShowShortcuts}>
