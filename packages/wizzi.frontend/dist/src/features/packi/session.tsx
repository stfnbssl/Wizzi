/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.frontend\.wizzi\src\features\packi\session.tsx.ittf
...
export default class Packi {
        constructor(options: PackiOptions) {
            ...
            this.state = this.updateDerivedState({
                ...
                user: options.user, 
                id: options.id, 
                saveURL: options.id ? createURL(this.host, undefined, options.id) : undefined, 
                online: false, 
                url: createURL(this.host, channel, options.id), 
                channel
             }, PackiIdentityState)
            ;
        ...
        */
        async saveAsync(options?: PackiSaveOptions) {
            ...
            try {
                ...
                const saveURL = createURL(this.host, undefined, id);
