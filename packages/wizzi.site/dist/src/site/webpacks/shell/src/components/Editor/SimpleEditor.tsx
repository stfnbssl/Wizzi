/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\Editor\SimpleEditor.tsx.ittf
                ...
                <Editor 
                    ...
                    highlight={(code: string) =>  
                            lineNumbers === 'on' ? this._highlight(selectedFile, code).split('\n').map((line: string) => 
                                    ...
                                    `<span class="${css(styles.line)}">${line}</span>`
                                ).join('\n')
