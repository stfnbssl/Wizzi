/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\Publish\ModalPublishToProfile.tsx.ittf
...
class ModalPublishToProfile extends React.Component<Props> {
    ...
    render() {
        ...
        return  (
            <ModalDialog
             visible={this.props.visible} title="Save your snack" onDismiss={this.props.onDismiss}>
                <p
                 className={css(styles.text)} style={{
                    ...
                    {' '}
                    <a
                     href={this.props.snackUrl} target="blank">
                        {this.props.snackUrl}
                    </a>
                </p>
                <p
