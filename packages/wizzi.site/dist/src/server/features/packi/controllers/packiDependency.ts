/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\server\src\features\packi\controllers\packiDependency.ts.ittf
...
export class Controller implements ControllerType {
    ...
    private updatePackiDependency = async (request: Request, response: Response) => 
