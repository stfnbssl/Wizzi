/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\EditorImportTitle.tsx.ittf
            ...
            <div className={css(styles.container)}>
                <div className={css(styles.header)}>
                    ...
                    <p className={css(styles.description)} style={{
                        ...
                        <span className={status === 'error' ? css(styles.error) : ''}>
                            {description}
                        </span>
                    </p>
                </div>
