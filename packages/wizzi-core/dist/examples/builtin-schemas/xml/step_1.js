/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\xml\step_1.js.ittf
*/
'use strict';
/**
...
var Schemas_json_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadWizziModel(path.join(__dirname, 'ittf', 'basic.xml.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
