/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-meta\.wizzi\ittf\examples\cheatsheet\step_1.js.ittf
*/
'use strict';
//
...
//
/**
     Examples: Meta_cheatsheet_step_1
...
var Meta_cheatsheet_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    heading2('Meta cheatscheet');
    loadAndTransformModel(path.join(__dirname, 'ittf', 'basic.meta.ittf'), {}, "cheatsheet/preprint", function(err, artifactText) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        heading2('Meta cheatscheet - transformation cheatsheet/hpreprint');
        printValue('cheatsheet/preprint', artifactText);
    });
};
Meta_cheatsheet_step_1.__name = 'Meta_cheatsheet_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 2 - Meta_cheatsheet_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Meta_cheatsheet_step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Meta_cheatsheet_step_1;
if (typeof require != 'undefined' && require.main === module) {
    Meta_cheatsheet_step_1();
}
