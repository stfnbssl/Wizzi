/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\features\form\EditorForm.tsx.ittf
                        ...
                        <Form onSubmit={this._handleSubmit}>
                                         ...
                                         : field.type === 'select' ?  (
                                                <div key={i} className={classes.fieldContainer}>
                                                    <ValidatedInput select
                                                        ...
                                                        margin="normal"
                                                        value={value}
                                                        onChange={// console.log('onChange', k, e.target.value);
                            ...
                            <div className={css(styles.buttons)}>
                                <div className={classes.button}>
                                    <SubmitButton type="submit" color="primary" variant="extended">
                                        {action}
                                    </SubmitButton>
                                </div>
                                <div className={classes.button}>
