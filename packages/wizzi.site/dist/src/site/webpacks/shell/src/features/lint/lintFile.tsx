/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\features\lint\lintFile.tsx.ittf
    utc time: Wed, 14 Apr 2021 15:53:09 GMT
*/
import {SnackFiles} from '../packi/index';
import {SnackFiles, Annotation} from '../annotations/index';
import {isESLintConfig, isScript, isJson} from '../file/index';
...
export default async function lintFile(selectedFile: string, files: SnackFiles):  Promise<Annotation[]> {
