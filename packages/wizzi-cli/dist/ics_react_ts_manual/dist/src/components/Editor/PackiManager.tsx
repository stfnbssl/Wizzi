/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\PackiManager.tsx.ittf
        ...
        return  (
            <div>
                ...
                <EditorForm title="Clone git package"
                    ...
                    fields={{
                        id: {
                            type: 'select', 
                            label: 'Package', 
                            options: ownedGitRepositories.map((item) => {
                                return {
                        ...
                        branch: {
                            type: 'select', 
                            label: 'Branch', 
                            options: gitBranchesTODO.map((name) => {
                                return {
                                        label: name, 
                                        value: name
                                     };
                ...
                }
                {
                    currentPacki
                     &&  (
                        <EditorForm title="Save packi template"
                            action="Confirm"
