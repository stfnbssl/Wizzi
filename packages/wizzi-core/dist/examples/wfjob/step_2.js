/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\wfjob\step_2.js.ittf
*/
'use strict';
/**
     Example: wfJob_step_1
...
var wfJob_step_1 = function(step_callback) {
    ...
    loadWizziModel(path.join(__dirname, 'ittf', 'execs.wfjob.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        printObject(wizziModel.toJson(), 'execs.wfjob');
    });
};
