/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-repo\.wizzi\ittf\examples\jsonComponents\step_1.js.ittf
*/
'use strict';
//
...
//
/**
     Examples: JsonComponents_Step_1
...
var JsonComponents_Step_1 = function(step_callback) {
    heading1('EXAMPLE');
    heading1('start');
...
function heading1(text) {
    ...
    console.log('** level 0 - step 1 - JsonComponents_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- JsonComponents_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = JsonComponents_Step_1;
if (typeof require != 'undefined' && require.main === module) {
    JsonComponents_Step_1();
}
