/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\client\src\features\packi\FileUploader.ts.ittf
    utc time: Tue, 11 May 2021 04:47:38 GMT
*/
                    ...
                    case 'ASSET': {
                        ...
                        if ((typeof FormData !== 'undefined' && file.contents instanceof FormData) || (typeof file.contents === 'object' && file.contents.constructor?.name === 'FormData')) {
                            ...
                            if (typeof FormData !== 'undefined') {
                                ...
                                throw new Error()// TODO: Add support for uploading files using ArrayBuffer in body to the /snack/uploadAsset end-point
