/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\GeneratedView.tsx.ittf
                        ...
                        <div className={classes.editor}>
                            {
                                ((this.props.generatedSourcePath.endsWith('.html.ittf') || this.props.generatedSourcePath.endsWith('.svg.ittf')) ?  (
                                    <IFramePage content={this.props.generatedContent} />
                                    )
                                 : (this.props.generatedSourcePath.endsWith('.md.ittf') ?  (
                                        <MarkdownElement text={this.props.generatedContent} />
                                        )
                                     :  (
                                        <h1>
