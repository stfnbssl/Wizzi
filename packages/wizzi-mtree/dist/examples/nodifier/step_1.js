/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-mtree\.wizzi\ittf\examples\nodifier\step_1.js.ittf
*/
'use strict';
//
...
var Nodifier_Step_1 = function(step_callback) {
    heading1('EXAMPLE');
    var ittfUri = path.join(__dirname, 'ittf', 'nodifier_1.ittf');
    var lines = liner(file.read(ittfUri), {
        sourceKey: 'f1'
    });
    var loadHistory = new LoadHistory();
    var mTree = new MTreeBrick(ittfUri, loadHistory);
    var nodes = nodifier(lines, mTree);
    console.log('nodifier nodes', nodes);
    printNodes(nodes);
};
Nodifier_Step_1.__name = 'Nodifier_Step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Nodifier_Step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Nodifier_Step_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Nodifier_Step_1;
