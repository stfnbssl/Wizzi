/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\client\src\components\Import\ImportExportMenu.tsx.ittf
    utc time: Mon, 03 May 2021 09:48:27 GMT
*/
import * as React from 'react';
import {SaveStatus} from '../../features/packi/index';
...
export default class ImportExportMenu extends React.PureComponent<Props, State> {
        ...
        render() {
            ...
            return  (
                ...
                >
                    <FileListPaneButton
                     ref={this._button} onClick={this._toggleContextMenu}>
                        <g
                         fillOpacity="0.7">
                            <circle
                             cy="3" cx="8" r="1.5" />
