/*
    ...
    primary source IttfDocument: C:\my\wizzi\stfnbssl\wizzi\packages\wizzi-web\.wizzi\ittf\examples\html\step_error.js.ittf
*/
'use strict';
//
...
html_step_1.__name = 'html_step_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - html_step_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
