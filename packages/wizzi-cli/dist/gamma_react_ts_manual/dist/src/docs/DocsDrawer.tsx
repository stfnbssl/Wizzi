/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\gamma_react_ts_manual\.wizzi\src\docs\DocsDrawer.tsx.ittf
...
const FilesLink = (props) => 
     (
    <Link to="/" {...props} />
    )

;
const VersionsLink = (props) => 
     (
    <Link to="/versions" {...props} />
    )
