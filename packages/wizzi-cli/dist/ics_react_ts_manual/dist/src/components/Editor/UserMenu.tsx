/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\UserMenu.tsx.ittf
        ...
        return  (
            <div className={css(styles.container)}>
                <button ref={this._avatar} className={css(styles.button)}>
                    <Avatar source={loggedUser && loggedUser.picture ? loggedUser.picture : require('../assets/avatar.svg')} size={40} />
                </button>
