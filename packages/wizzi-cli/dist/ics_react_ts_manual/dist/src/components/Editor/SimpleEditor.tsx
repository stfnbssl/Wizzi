/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\Editor\SimpleEditor.tsx.ittf
            ...
            <div className={classnames(classes.container, lineNumbers === 'on' && classes.containerWithLineNumbers)}>
                <Editor ref={this._editor}
                    ...
                    highlight={(code: string) => 
                        lineNumbers === 'on' ? this._highlight(code).split('\n').map((line: string) => 
                                `<span class="${classes.line}">${line}</span>`
                            ).join('\n')
