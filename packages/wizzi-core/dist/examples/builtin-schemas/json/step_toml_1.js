/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\json\step_toml_1.js.ittf
*/
'use strict';
/**
     Example: Schemas_json_step_toml_1
...
var Schemas_json_step_toml_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'basictoml.json.ittf'), {}, "json/toml", function(err, artifactText) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        printValue('toml', artifactText);
    });
};
Schemas_json_step_toml_1.__name = 'Schemas_json_step_toml_1';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 1 - Schemas_json_step_toml_1 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_json_step_toml_1 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_json_step_toml_1;
if (typeof require != 'undefined' && require.main === module) {
    Schemas_json_step_toml_1();
}
