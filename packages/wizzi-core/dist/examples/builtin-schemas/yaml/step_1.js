/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\yaml\step_1.js.ittf
*/
'use strict';
/**
...
var Schemas_yaml_step_1 = function(step_callback) {
    heading1('EXAMPLE');
    loadWizziModel(path.join(__dirname, 'ittf', 'basic.yaml.ittf'), {}, function(err, wizziModel) {
        if (err) {
            console.log('err', err);
