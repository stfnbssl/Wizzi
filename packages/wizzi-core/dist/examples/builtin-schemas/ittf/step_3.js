/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-core\.wizzi\ittf\examples\builtin-schemas\ittf\step_3.js.ittf
*/
'use strict';
/**
     Example: Schemas_ittf_step_3
...
var Schemas_ittf_step_3 = function(step_callback) {
    heading1('EXAMPLE');
    heading2('Ittf builtin schema');
    loadAndTransformModel(path.join(__dirname, 'ittf', 'cheatsheet.ittf.ittf'), {}, "ittf/cheatsheet", function(err, transformed) {
        if (err) {
            console.log('err', err);
            throw new Error(err.message);
        }
        heading2('Ittf builtin schema - transformation ittf/cheatsheet');
        console.log('Object.keys(transformed)', Object.keys(transformed));
        // _ printValue('ittf/cheatsheet', Object.keys(transformed))
        loadModelAndGenerateArtifact(path.join(__dirname, 'ittf', 'cheatsheet.html.ittf'), {
            mTreeBuildUpContext: {
                cs: {
            ...
            heading2('Cheatsheet document');
            printValue('html/document', artifactText);
        });
    });
};
Schemas_ittf_step_3.__name = 'Schemas_ittf_step_3';
function heading1(text) {
    console.log('');
    console.log('*'.repeat(120));
    console.log('** level 0 - step 3 - Schemas_ittf_step_3 - ' + text);
    console.log('*'.repeat(120));
    console.log('');
}
function heading2(text) {
    ...
    console.log('   ','-- Schemas_ittf_step_3 - ' + text);
    console.log('   ', '-'.repeat(100));
    console.log('');
}
...
module.exports = Schemas_ittf_step_3;
