/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\sigma_express_auth\.wizzi\src\features\wizzi\productions.js.ittf
...
export async function loadModelFs(filePath, context) {
    return new Promise(async (resolve, reject) => {
            ...
            wf.loadModel(schemaName, filePath, {
                ...
                // log 'features.wizzi.productions.loadModelFs.result', result
                resolve(result);
            })
        });
}
export async function generateArtifactFs(filePath, context) {
    return new Promise(async (resolve, reject) => {
            ...
            if (generator) {
                // log 'features.wizzi.productions.generateArtifactFs.using artifact generator', generator
                const wf = await createFilesystemFactory();
                wf.loadModelAndGenerateArtifact(filePath, {
                    ...
                    // log 'features.wizzi.productions.generateArtifactFs.result', result
                    resolve({
