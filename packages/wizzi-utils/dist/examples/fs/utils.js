/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-utils\.wizzi\ittf\examples\fs\utils.js.ittf
*/
'use strict';
/**
...
var fsUtils_Step_1 = function(step_callback) {
    ...
    var fi = fsUtils.fileInfoByPath(fname);
    printObject(fi);
    fname = path.join(__dirname, 'folder1', 'test.html.ittf');
