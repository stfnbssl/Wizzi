/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi-cli\dist\ics_react_ts_manual\.wizzi\src\components\filelist\FileListEntryBase.tsx.ittf
            ...
            return  (
                ...
                >
                    ...
                    <ContextMenu ref={this._menu}
                     ...
                     />
                    <button ref={this._more} tabIndex={-1} className={css(styles.more, isHovered || menu ? styles.moreVisible : styles.moreInvisible)}>
