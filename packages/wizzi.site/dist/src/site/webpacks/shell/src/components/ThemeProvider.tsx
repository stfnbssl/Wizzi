/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\ThemeProvider.tsx.ittf
...
const lightColors = {
    ...
    background: '#F9F9F9'// semantic.background offered too little contrast with content
...
const styles = StyleSheet.create({
    ...
    light: {
        ...mapKeys(lightColors, (_, key) => 
        
            `--color-${key}`
        ), 
        ...mapKeys(lightShadows, (_, key) => 
        
            `--shadow-${key}`
        )
     }, 
    dark: {
        ...mapKeys(darkColors, (_, key) => 
        
            `--color-${key}`
        ), 
        ...mapKeys(darkShadows, (_, key) => 
