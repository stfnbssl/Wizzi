/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi\packages\wizzi.site\.wizzi\src\site\webpacks\shell\src\components\widgets\Spinner.tsx.ittf
...
export default function Spinner({
        ...
        const {
            ...
            blue, 
            alpha
         } = color !== undefined ? color : prefs.theme === 'dark' ? {
                    red: 255, 
                    green: 255, 
                    blue: 255, 
                    alpha: 0.5
